...
builder.Services.AddKeyedScoped(typeof(IBrowserStorageService<>), nameof(LocalStorageService<>),
    typeof(LocalStorageService<>));
builder.Services.AddKeyedScoped(typeof(IBrowserStorageService<>), nameof(SessionStorageService<>),
